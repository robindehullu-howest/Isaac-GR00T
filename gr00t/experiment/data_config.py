...
class So100DataConfig(BaseDataConfig):
    video_keys = ["video.top", "video.frontal", "video.gripper"]
...
class So100TopFrontalDataConfig(BaseDataConfig):
    video_keys = ["video.top", "video.frontal"]
    state_keys = ["state.single_arm", "state.gripper"]
    action_keys = ["action.single_arm", "action.gripper"]
    language_keys = ["annotation.human.task_description"]
    observation_indices = [0]
...
class So100TopGripperDataConfig(BaseDataConfig):
    video_keys = ["video.top", "video.gripper"]
    state_keys = ["state.single_arm", "state.gripper"]
    action_keys = ["action.single_arm", "action.gripper"]
    language_keys = ["annotation.human.task_description"]
    observation_indices = [0]
...
class So100BimanualDataConfig(BaseDataConfig):
    video_keys = ["video.top", "video.main_gripper", "video.secondary_gripper"]
    state_keys = ["state.main_arm", "state.main_gripper", "state.secondary_arm", "state.secondary_gripper"]
    action_keys = ["action.main_arm", "action.main_gripper", "action.secondary_arm", "action.secondary_gripper"]
    language_keys = ["annotation.human.task_description"]
    observation_indices = [0]
    action_indices = list(range(16))
...
DATA_CONFIG_MAP = {
    ...
    "so100_top_frontal": So100TopFrontalDataConfig(),
    "so100_top_gripper": So100TopGripperDataConfig(),
    "so100_bimanual": So100BimanualDataConfig(),
}
